...
cisco.factory('currencyService',function($rootScope, $http, $q) {
    ...
    //]
    return {
        getCurrency: function(currency_name){
           ...
           //     if(currency_symbols[i].abbreviation == currency_name) {
           //         return (currency_symbols[i].symbol);
           //     }
           // }
           //return 'NA';
